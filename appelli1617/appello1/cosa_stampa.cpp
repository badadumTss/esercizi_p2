...
int main(){
  ...
  p4->g(); cout << endl;	// B::g
  p5->g(); cout << endl;	// C::g
  // p6->k(); cout << endl;	// errore compile time: calling B::k discards const qualifier
  p6->g(); cout << endl;	// A::g
...
/*
A compile time lui vede solo i tipi statici!!!
p3->n() per il compilatore è un A*, di conseguenza deve bindare la chiamata dopo ->g() su un A*, non sul tipo dinamico B*!!!

le cose cambiano coi cast (dynamic o static) a quel punto assume che il puntatore sia del tipo target per le chiamate successive!!!!
*/
